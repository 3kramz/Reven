    ...
    return (
        <div className=' mt-10'>
           ...
           <form className=" container mx-auto px-5" onSubmit={handleSubmit}>
            ...
            <br />
             <input className='bg-[#F46617] w-full mb-2 py-4 text-white cursor-pointer' type="submit" value="Login" />
        </form>
        <p>Do not have any account? <Link className="text-[#F46617]" to={"/signup"}>Sign up</Link></p>
        <hr/>
