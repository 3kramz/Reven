   ...
   console.log(id)
    ...
    return (
        <div className='mt-10'>
            ...
            <div className='h-25 w-[83.4px] border-[#F46617] border-2 '><p className='text-white fs-[14px] bg-[#F46617] py-[5px] px-[10px] '>featured</p></div>
            <div className='border-t-[#F46617] border-t-4  sm:flex'>
                ...
                <div className='sm:w-3/5 mt-2 sm:mt-0 '> 
                    <div className=' flex justify-between bg-[#f7f7f7] border-b-[#D4D4D4] border-b-2  h-[60px] text-left text-2xl  font-bold ' >
                        ...
                        <Link to={ `/inventory/${_id}`}className=' flex items-center px-8 bg-[#F46617]  border-b-[#F46617]  text-white' > Update</Link>
