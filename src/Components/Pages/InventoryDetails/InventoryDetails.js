...
const InventoryDetails = () => {
    ...
    return (
        <div className='my-10 container mx-auto'>
            <div className='h-25 w-[83.4px] border-[#F46617] border-2 '><p className='text-white fs-[14px] bg-[#F46617] py-[5px] px-[10px] '>{condition}</p>
            </div>
            <div className='border-t-[#F46617] border-t-4  sm:flex'>
                ...
                <div className='sm:w-3/5 mt-2 sm:mt-0 '> 
                    <div className=' flex justify-between bg-[#f7f7f7] border-b-[#D4D4D4] border-b-2  h-[60px] text-left text-2xl  font-bold ' >
                        <p className=' flex items-center pl-5  text-[#F46617] '>{name}</p>
                        <button onClick={handleSaveBtn} className=' flex items-center px-8 bg-[#F46617]  border-b-[#F46617]  text-white' > Save</button>
                    </div>
             ...
             <div >
                    <div className=''>
                            <button onClick={handleDalivered} className='bg-[#F46617]  w-64  py-2 text-white text-xl rounded  m-4 '>Delivered</button>
                    </div>
                    <form className='flex w-full  mx-auto border-2' onSubmit={handleSubmit}>
                        ...
                        <input className="w-2/5 sm:w-1/5 bg-[#F46617] px-4 py-2 cursor-pointer text-white"  type="submit" value="Update stock" />
                    </form>
             </div>
